...
-- SELECT
--   TO_CHAR(createdat, 'MON YYYY') AS createdat,
--   positionname,
--   companyname,
--   status
--   FROM jobapplications WHERE (seeduserid = 111111);
...
--   offeroptions,
--   offerbenefits
--  FROM jobapplications WHERE (seeduserid = 111111 AND seedapplicationid = 444);

-- --Query notes specific to the job application

-- SELECT
--   TO_CHAR(createdat, 'DD MON YYYY   HH12:MI:SS') AS createdat,
--   activitylogcontent
--   FROM activitylogs WHERE seedapplicationid = 444 AND activitytype = 'NOTE'
--   GROUP BY createdat, activitylogcontent ORDER BY createdat DESC;

-- --Query URLs specific to the job application

-- -- SELECT
-- --   activitylogcontent
-- --   FROM activitylogs WHERE seedapplicationid = 444 AND activitytype = 'ARTICLE'
-- --   GROUP BY createdat, activitylogcontent ORDER BY createdat DESC;
